                ...
                <div class="box box-primary-ufop">
                    <div class="box-body">
                        ...
                        <div class="form-group {{ $errors->has('validade') ? ' has-error' : '' }}">
                            <div class="input-group">
                                ...
                                <input id="datepicker" name="validade" value="{{ $errors->has('validade') ? old('validade') : $requisicao->validade }}" type="text" minlength="10" maxlength="10" class="form-control" placeholder="Validade do cadastro" data-toggle="tooltip" data-placement="top" title="Validade">
                            </div>
                    ...
                    <div class="box-footer text-center">
                        ...
                        @elseif ($requisicao->status == 4)
                            <a href="{{ route('reactiveRequisicao', $requisicao->id)}}" class="btn btn-primary"><i class="fa fa-power-off"></i> Desbloqueado</a>
                        @endif
