        ...
        <div class="form">
            <form class="form" action="{{ route('login') }}" method="post">
                ...
                <div class="input-group {{ $errors->has('username') ? 'has-error' : '' }}">
                    ...
                    <input type="text" data-mask="000.000.000-00" data-mask-reverse="true" name="username" class="form-control" maxlength="14" minlength="11" placeholder="CPF do Minha UFOP" required value="{{ old('username') }}" {{ $errors->has('username') ? 'autofocus' : '' }} data-toggle="tooltip" data-placement="right" title="CPF do Minha UFOP" >
                </div>

                <div class="input-group {{ $errors->has('password') ? 'has-error' : '' }}">
                    <span class="input-group-addon"><i class="fa fa-lock"></i></span>
                    <input type="password" name="password" class="form-control" placeholder="Senha do Minha UFOP" required {{ $errors->has('password') ? 'autofocus' : '' }} data-toggle="tooltip" data-placement="right" title="Senha do Minha UFOP">
                </div>
