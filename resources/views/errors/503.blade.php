...
<html lang="pt">
<head>
    <title>Sistema de Gerência de Rede - Em Manutenção</title>
    <meta charset="utf-8">
...
<footer class="text-center">
    <!-- Default to the left -->
    <strong>Copyleft <i class="fa fa-creative-commons"></i> {{ date("Y") }} <a href="{{ url('https://github.com/jpmoura/macnager-ufop#macnager---sistema-de-gerenciamento-de-rede') }}">NTI ICEA</a></strong>.
</footer>
