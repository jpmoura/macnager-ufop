      ...
      <div class="box box-primary-ufop">
        <div class="box-header">
          <ul class="nav nav-tabs">
            <li role="presentation" @if($tipo == 1) class="active" @endif><a href="{{url('/listMac/1')}}"><i class="fa fa-check"></i> Ativos</a></li>
            <li role="presentation" @if($tipo == 3) class="active" @endif><a href="{{url('/listMac/3')}}"><i class="fa fa-history"></i> Vencidos</a></li>
            <li role="presentation" @if($tipo == 4) class="active" @endif><a href="{{url('/listMac/4')}}"><i class="fa fa-ban"></i> Suspensos</a></li>
            <li role="presentation" @if($tipo == 5) class="active" @endif><a href="{{url('/listMac/5')}}"><i class="fa fa-power-off"></i> Desligados</a></li>
          </ul>
        </div>
        <div class="box-body">
          <div class="table">
              ...
              <tbody>
                @foreach($liberados as $registro)
                  <tr>
                    ...
                    @if ($tipo < 5)
                      <td>
                        <a href="{{url('editMac') . "/" . $registro->id}}" class="btn btn-xs btn-ufop"><i class="fa fa-edit"></i> Editar</a>
                      </td>
                    @endif
                  </tr>
                @endforeach
